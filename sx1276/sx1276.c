...
//uint32_t REG_FREQ[128];
//uint32_t reg_freq_index=0;
void SX1276SetChannel( uint32_t freq )
{
    SX1276.Settings.Channel = freq;
    //REG_FREQ[reg_freq_index++]=freq;
...
//uint16_t REG_Buffer[256];
//uint16_t REG_Check[128];
//uint16_t reg_check_index=0;
//uint16_t reg_fifo_flag=0xFF00;
...
//    	for( i = 0; i < size; i++ )
//    	{
//    		REG_Buffer[addr+i]=buffer[i]|0xFF00;
//    	}
//
//    }
//    else{
//    	reg_fifo_flag = 0xEE00;
//    }
//    if(addr==1 && size == 1){
//    	REG_Check[reg_check_index++]=buffer[0]|reg_fifo_flag;
//    }
}
